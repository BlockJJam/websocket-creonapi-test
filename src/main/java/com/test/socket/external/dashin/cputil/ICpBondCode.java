...
public interface ICpBondCode extends Com4jObject {
  ...
  @VTID(9)
  com.test.socket.external.dashin.cputil.CPE_BOND_TYPE type();
  ...
  @VTID(10)
  com.test.socket.external.dashin.cputil.CPE_BOND_REMAIN remain();
  ...
  @VTID(11)
  com.test.socket.external.dashin.cputil.CPE_BOND_ISSUE issue();
  ...
  @VTID(12)
  com.test.socket.external.dashin.cputil.CPE_BOND_INTEREST interest();
  ...
  @VTID(15)
  com.test.socket.external.dashin.cputil.CPE_BOND_RETAIL retail();
